var validator = (function () {
    ...
    function validate_email(emailAddress, error) {
        ...
        if (pattern.test(emailAddress)) {
            ...
            error.code = 1;
            error.message = 'Введите корректный  e-mail';
            return false;
        }
    }
    ...
    function validate_bik(bik, error) {
        var result = false;
    ...
    function validate_inn(inn, error) {
        var result = false;
    ...
    function validate_kpp(kpp, error) {
        var result = false;
    ...
    function validate_ks(ks, bik, error) {
        var result = false;
    ...
    function validate_ogrn(ogrn, error) {
        var result = false;
    ...
    function validate_ogrnip(ogrnip, error) {
        var result = false;
    ...
    function validate_rs(rs, bik, error) {
        var result = false;
        if (validateBik(bik, error)) {
            if (typeof rs === 'number') {
                rs = rs.toString();
    ...
    function validate_snils(snils, error) {
        var result = false;
    ...
    function _validator(validatortype, value) {
